...
本アセットは、制作時点の環境（UnityおよびVRCSDK等）を前提として構築されています。今後のUnityのアップデートや環境の変化によって、正常に動作しなくなる可能性があります。

また、本アセットの使用によって万が一何らかのトラブルや不都合が生じた場合、制作者側での対応や責任の補償はいたしかねます。恐れ入りますが、あらかじめご了承の上でご利用をお願いいたします。
